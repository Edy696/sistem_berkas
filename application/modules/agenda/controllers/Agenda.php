...
class Agenda extends MY_Controller {
    ...
    public function index()
    {
        ...
        $data['list_agenda'] = $this->agenda_m->get_agenda();
    ...
    public function add(){
        ...
        if($this->form_validation->run()==false){
            ...
            if($this->agenda_m->add_agenda($data)>0)
                echo "success";
            else
                echo "failed";
        }
    ...
    public function save($id){
        ...
        if($this->form_validation->run()==false){
            ...
            $data['agenda'] = $this->agenda_m->get_agenda_by_id($id);
            $this->load->view('templates/header', $data);
            $this->load->view('agenda/add', $data);
            $this->load->view('templates/footer');
        }else{
    ...
    public function data(){
        $result = $this->agenda_m->result();
        $total_rows = $this->agenda_m->total_rows();
